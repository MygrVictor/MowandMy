...
## Mow & My — site personnalisé

Ce dépôt a été adapté pour un site de type "Mow & My" (restaurant, coffee shop, coworking) avec:

- Page d'accueil animée "porte" qui mène à l'accueil
- Pages: Accueil, Restaurant, Coffee, Coworking, Ateliers
- Back-office simple accessible sur `/admin` (mot de passe par défaut: `admin`)
- Données (horaires, ateliers) stockées en `localStorage` pour la démo
